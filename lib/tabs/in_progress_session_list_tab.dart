...
import 'package:myprocess/tasks/counter_in_progress_widget.dart';

import '../tasks/todo_in_progress_widget.dart';
      ...
      child: Card(
        child: Column(
          ...
          children: <Widget>[
            ...
            TodoInProgressWidget(
              sessionInstance: widget.sessionInstance,
            ),
            CounterInProgressWidget(sessionInstance: widget.sessionInstance),
